  ...
  data() {
    return {
      questions: [
        ...
        {
          text: '6. Практически в любом коллективе присутствует зависть или подсиживание.',
          answers: [
            { text: 'Да', value: '3' },
            { text: 'Нет', value: '0' },
          ],
        ...
        {
          text: '7. Большинство людей лишено чувства сострадания к другим.',
          answers: [
            { text: 'Да', value: '8' },
            { text: 'Нет', value: '0' },
          ],
        ...
        {
          text: '8. Большинство работников на предприятиях и в учреждениях старается прибрать к рукам всё, что плохо лежит.',
          answers: [
            { text: 'Да', value: '1' },
            { text: 'Нет', value: '0' },
          ],
        ...
        {
          text: '9. Подростки в большинстве своем сегодня воспитаны хуже, чем когда бы то ни было.',
          answers: [
            { text: 'Да', value: '2' },
            { text: 'Нет', value: '0' },
          ],
